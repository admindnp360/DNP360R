...
const s = StyleSheet.create({
  ...
  waCommRow:       { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10, paddingVertical: 7 },
  waCommAvatar:    { width: 27, height: 27, borderRadius: 14, justifyContent: 'center', alignItems: 'center' },
  waCommAvatarTxt: { color: '#fff', fontSize: 9, fontFamily: 'Inter_700Bold' },
