...
const s = StyleSheet.create({
  ...
  waCommRow:       { flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 9, paddingVertical: 6 },
  waCommAvatar:    { width: 24, height: 24, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  waCommAvatarTxt: { color: '#fff', fontSize: 8, fontFamily: 'Inter_700Bold' },
