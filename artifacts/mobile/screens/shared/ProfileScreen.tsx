...
const styles = StyleSheet.create({
  ...
  avatar: { width: 88, height: 88, borderRadius: 44, backgroundColor: 'rgba(255,255,255,0.22)', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: 'rgba(255,255,255,0.45)' },
  avatarLetter: { color: '#FFFFFF', fontSize: 40, fontFamily: 'Inter_700Bold' },
  editAvatarBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 14, paddingVertical: 7, borderRadius: 99, borderWidth: 1 },
  editAvatarText: { color: '#FFFFFF', fontSize: 12, fontFamily: 'Inter_600SemiBold' },
  roleBadge: { paddingHorizontal: 16, paddingVertical: 6, borderRadius: 99 },
  roleBadgeText: { fontSize: 12, fontFamily: 'Inter_600SemiBold' },
  profileName: { color: '#FFFFFF', fontSize: 24, fontFamily: 'Inter_700Bold', marginTop: 2 },
